...
export default (props) => {
  ...
  return Scene({...props,
    ...
    render() {
      ...
      drawTextWithShadow(context, 'Benny', context.canvas.width / 4, 50, 5 * scale, '#FF0', 3, 2);
      drawTextWithShadow(context, 'Bird', context.canvas.width / 4, 110 + (scale * 30), 3 * scale, '#FF0', 3, 2);
